    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-50 px-0 py-0 sm:px-8 sm:py-5">
            <div className="flex items-center justify-between
                ...
                <GlowingBorderButton className='p-0 sm:p-1'><a href="https://github.com/namansingla01022008-lab/passop" target='_blank' className='flex items-center gap-2'> <img src={githubIcon} alt="svg" className='text-white' /><span className='hidden sm:flex'>Github</span></a></GlowingBorderButton>
            </div>
        </nav>
    )
}
